        ...
        <div className="mt-12 grid gap-6 sm:mt-16 sm:grid-cols-2 lg:grid-cols-3">
          {teamMembers.map((member, index) => (
            <motion.div
              ...
              className="group overflow-hidden rounded-2xl border border-[#A48C45]/20 bg-[#071B23] transition-all duration-500 hover:border-[#A48C45]/60 hover:shadow-[0_20px_45px_rgba(164,140,69,0.15)]"
            >
              <div className="relative aspect-[4/4.5] overflow-hidden sm:aspect-[4/5]">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-[#021D26]/60 via-transparent to-transparent opacity-0 transition duration-500 group-hover:opacity-100" />
              </div>

              <div className="p-4 sm:p-6">
                <h3 className="text-xl font-semibold text-white transition duration-300 group-hover:text-[#A48C45] sm:text-2xl">
                  {member.name}
                </h3>

                <p className="mt-2 text-xs uppercase tracking-[0.14em] text-[#A48C45] sm:text-sm sm:tracking-[0.18em]">
                  {member.role}
                </p>
              </div>
            </motion.div>
