        ...
        <div className="mt-16 grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
          {teamMembers.map((member, index) => (
            ...
            >
              ...
              <div className="p-6">
                <h3 className="text-2xl font-semibold text-white transition duration-300 group-hover:text-[#A48C45]">
                  {member.name}
                </h3>

                <p className="mt-2 text-sm uppercase tracking-[0.18em] text-[#A48C45]">
                  {member.role}
                </p>
              </div>
            </motion.div>
